<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a _href="{{url('admin/category')}}" data-title="生活服务分类" href="javascript:void(0)">生活服务分类</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a _href="{{url('admin/city')}}" data-title="城市列表" href="javascript:void(0)">城市分类</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a _href="{{url('admin/bis/index')}}" data-title="商家列表" href="javascript:void(0)">商户列表</a></li>
                    <li><a _href="{{url('admin/bis/apply')}}" data-title="商家入驻申请" href="javascript:void(0)">商家入驻申请</a></li>
                    <li><a _href="{{url('admin/bis/del')}}" data-title="删除的商户" href="javascript:void(0)">删除的商户</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a _href="{{url('admin/deal/review')}}" data-title="商家团购提交" href="javascript:void(0)">商家团购提交</a></li>
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a _href="{{url('admin/featured/add')}}" data-title="添加推荐位内容" href="javascript:void(0)">添加推荐位内容</a></li>
                    <li><a _href="{{url('admin/featured/index')}}" data-title="推荐位列表" href="javascript:void(0)">推荐位列表</a></li>
